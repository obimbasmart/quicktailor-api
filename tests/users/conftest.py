...
import pytest
from src.carts.schemas import AddCart, RemoveCart


_info_update_fields = {"username": "arekak", "email": "ammalino@gmail.com", "password": "Imaewwr22@", "phone": "08123456799"}
_info_update_fields_02 = {"username": "arek", "email": "tester02@gmail.com", "password": "Imaewwr22@", "phone": "08123456789"}
...
def create_new_cart():
    def create_cart(product_id: str, measurements: dict = _measurement_update_fields):
        return AddCart( product_id = product_id, measurements=measurements)
    return create_cart
@pytest.fixture
